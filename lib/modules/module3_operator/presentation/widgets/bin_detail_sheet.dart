    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: OperatorTheme.hairline),
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: OperatorTheme.accent, width: 2),
        ),
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: const TextStyle(color: OperatorTheme.mutedText),
        filled: true,
        fillColor: OperatorTheme.surface,
