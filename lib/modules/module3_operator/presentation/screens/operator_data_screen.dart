...
class _OperatorDataScreenState extends State<OperatorDataScreen>
  ...
  void initState() {
    ...
    _syncService = OfflineSyncService(
      ...
      baseUrl: 'http:// 192.168.5.92:8000/api/desktop/waste',
    )..start();
  ...
  Future<void> _fetchWasteTypes() async {
    ...
    try {
      final response = await http
          .get(
            Uri.parse(
              'http://192.168.5.92:8000/api/desktop/waste/get-waste-types/',
            ),
          )
  ...
  Future<void> _fetchWasteRecord(String type) async {
    try {
      final uri = Uri.parse(
          'http:// 192.168.5.92:8000/api/desktop/waste/get-latest-waste/');
  ...
  Future<void> _handleAdd(String type) async {
    ...
    try {
      final uri = Uri.parse(
        isUpdate
            ? 'http:// 192.168.5.92:8000/api/desktop/waste/update-waste-sub/'
            : 'http:// 192.168.5.92:8000/api/desktop/waste/insert-waste-sub/',
      );
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final uri = Uri.parse(
          'http:// 192.168.5.92:8000/api/desktop/waste/finalize-waste/');
