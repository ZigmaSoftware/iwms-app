...
class _OperatorDataScreenState extends State<OperatorDataScreen>
  ...
  void initState() {
    ...
    _syncService = OfflineSyncService(
      ...
      baseUrl: 'http://192.168.4.97:5000/api/mobile/waste',
    )..start();
  ...
  Future<void> _fetchWasteTypes() async {
    ...
    try {
      final response = await http
          .get(
            Uri.parse(
              'http://192.168.4.97:5000/api/mobile/waste/get-waste-types/',
            ),
          )
  ...
  Future<void> _fetchWasteRecord(String type) async {
    try {
      final uri = Uri.parse(
          'http://192.168.4.97:5000/api/mobile/waste/get-latest-waste/');
  ...
  Future<void> _handleAdd(String type) async {
    ...
    try {
      ...
      final uri = Uri.parse(
        isUpdate
            ? 'http://192.168.4.97:5000/api/mobile/waste/update-waste-sub/'
            : 'http://192.168.4.97:5000/api/mobile/waste/insert-waste-sub/',
      );
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final uri = Uri.parse(
          'http://192.168.4.97:5000/api/mobile/waste/finalize-waste/');
